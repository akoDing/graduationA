...
export class ListComponent implements OnInit, AfterViewInit {
  ...
  chartDataDepart() {
    const data = [
      { name: '毕业率', 学院: '文学院', 利率: 88.9 },
      { name: '毕业率', 学院: '理学院', 利率: 78.8 },
      { name: '毕业率', 学院: '法学院', 利率: 99.3 },
      { name: '毕业率', 学院: '英语系', 利率: 61.4 },
      { name: '毕业率', 学院: '计算机系', 利率: 87 },
      { name: '毕业率', 学院: '管理学院', 利率: 70.3 },
      { name: '毕业率', 学院: '音乐学院', 利率: 94 },
      { name: '毕业率', 学院: '电影学院', 利率: 95.6 },
      { name: '就业率', 学院: '文学院', 利率: 82.4 },
      { name: '就业率', 学院: '理学院', 利率: 93.2 },
      { name: '就业率', 学院: '法学院', 利率: 94.5 },
      { name: '就业率', 学院: '英语系', 利率: 79.7 },
      { name: '就业率', 学院: '计算机系', 利率: 92.6 },
      { name: '就业率', 学院: '管理学院', 利率: 85.5 },
      { name: '就业率', 学院: '音乐学院', 利率: 87.4 },
      { name: '就业率', 学院: '电影学院', 利率: 92.4 },
    ];
